<template>
    <div>
        ...
        <el-table border :data="records">
            ...
            <el-table-column prop="" label="操作">
                <template slot-scope="{row,$index}">
                    ...
                    <el-button type="success" icon="el-icon-sort-up" size="mini" v-else @click="cancel(row)">
                    </el-button>
        ...
        <el-pagination style="text-align:center" :total="total" :current-page="page" :page-sizes="[3,5,10]"
            @current-change="getSkuList" @size-change="handleSizeChange" :page-size="limit"
